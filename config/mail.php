...
return [
    ...
    */
    'mailers' => [
        ...
        'alert' => [
            'transport' => 'smtp',
            'host' => env('ALERT_MAIL_HOST', 'smtp.mailgun.org'),
            'port' => env('ALERT_MAIL_PORT', 587),
            'encryption' => env('ALERT_MAIL_ENCRYPTION', 'tls'),
        ...
        'billing' => [
            'transport' => 'smtp',
            'host' => env('BILLING_MAIL_HOST', 'smtp.mailgun.org'),
            'port' => env('BILLING_MAIL_PORT', 587),
            'encryption' => env('BILLING_MAIL_ENCRYPTION', 'tls'),
