...
/**
 * RoleNotification event broadcasts notifications to users with specific roles.
 *
 * This event is triggered when a notification is sent to users based on their roles,
 * broadcasting details such as title, message, and custom HTML content to private channels.
 * It uses the options array for HTML, image, and sender data, aligning with NotificationService.
 */
class RoleNotification implements ShouldBroadcast
{
    ...
    /**
     * Create a new RoleNotification event instance.
     *
     ...
     * @param string $category Notification category (e.g., 'project', 'policy').
     * @param string $type Notification type (e.g., 'info', 'update').
