...
/**
 * CompanyNotification event broadcasts notifications to users within specific companies.
 *
 * This event is triggered when a notification is sent to users associated with specific
 * companies, broadcasting details such as title, message, and custom HTML content.
...
class CompanyNotification implements ShouldBroadcast
{
    ...
    /**
     * Create a new CompanyNotification event instance.
     *
     ...
     * @param string $category Notification category (e.g., 'event', 'announcement').
     * @param string $type Notification type (e.g., 'announcement', 'info').
