...
/**
 * Token controller for handling specific ShiftsAndOvertimes module operations.
 */
class TokenCtrl extends Controller
{
    /**
     * Handles custom operations for the ShiftsAndOvertimes module.
     *
    ...
    public function index(Request $request, array $params)
    {
        try {
            ...
            switch ($action) {
                case 'ShiftsAndOvertimes_custom':
