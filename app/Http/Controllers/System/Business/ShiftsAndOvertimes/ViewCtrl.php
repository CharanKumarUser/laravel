...
/**
 * Controller for rendering the view form for ShiftsAndOvertimes entities.
 */
class ViewCtrl extends Controller
{
    ...
    /**
     * Renders a popup form for viewing ShiftsAndOvertimes entities.
     *
            ...
            switch ($reqSet['key']) {
                case 'ShiftsAndOvertimes_entities':
                    $popup = [
                        ...
                        'size' => 'lg',
                        'position' => 'center',
                        'label' => 'View ShiftsAndOvertimes Entity',
                        'short_label' => '',
                        'form' => 'builder',
                        'labelType' => 'above',
                        'content' => '
                    ...
                    $message = 'ShiftsAndOvertimes entity view form loaded successfully.';
                    break;
