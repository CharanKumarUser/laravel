...
/**
 * Controller for saving new ShiftsAndOvertimes entities.
 */
class FormCtrl extends Controller
{
    /**
     * Saves new ShiftsAndOvertimes entity data based on validated input.
     *
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            $validated = [];
            $title = 'Success';
            $message = 'ShiftsAndOvertimes data saved successfully.';
            /****************************************************************************************************
             *                                                                                                  *
            ...
            switch ($reqSet['key']) {
                case 'ShiftsAndOvertimes_entities':
                    ...
                    $title = 'Entity Added';
                    $message = 'ShiftsAndOvertimes entity configuration added successfully.';
                    break;
                default:
