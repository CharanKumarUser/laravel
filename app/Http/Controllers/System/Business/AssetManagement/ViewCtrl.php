...
/**
 * Controller for rendering the view form for AssetManagement entities.
 */
class ViewCtrl extends Controller
{
    ...
    /**
     * Renders a popup form for viewing AssetManagement entities.
     *
            ...
            switch ($reqSet['key']) {
                case 'AssetManagement_entities':
                    $popup = [
                        ...
                        'size' => 'lg',
                        'position' => 'center',
                        'label' => 'View AssetManagement Entity',
                        'short_label' => '',
                        'form' => 'builder',
                        'labelType' => 'above',
                        'content' => '
                    ...
                    $message = 'AssetManagement entity view form loaded successfully.';
                    break;
