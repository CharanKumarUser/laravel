            ...
            switch ($reqSet['key']) {
                ...
                case 'business_support_my_tickets':
                    $popup = [
                        ...
                        'labelType' => 'floating',
                        'fields' => [
                            ['type' => 'select', 'name' => 'issue_scope', 'label' => 'Issue Scope', 'value' => $data->issue_scope, 'options' => ['Internal' => 'Internal', 'External' => 'External'], 'required' => true, 'col' => '12', 'attr' => ['data-select' => 'dropdown']],
                            ['type' => 'select', 'name' => 'issue_priority', 'label' => 'Priority', 'value' => $data->issue_priority, 'options' => ['Low' => 'Low', 'Medium' => 'Medium', 'High' => 'High', 'Critical' => 'Critical'], 'required' => true, 'col' => '6', 'attr' => ['data-select' => 'dropdown']],
                            ['type' => 'select', 'name' => 'issue_status', 'label' => 'Status', 'value' => $data->issue_status, 'options' => ['Open' => 'Open', 'In Progress' => 'In Progress', 'Resolved' => 'Resolved', 'Closed' => 'Closed', 'Reopened' => 'Reopened'], 'required' => true, 'col' => '6', 'attr' => ['data-select' => 'dropdown']],
