...
/**
 * Controller for rendering the view form for SupportAndHelp entities.
 */
class ViewCtrl extends Controller
{
    ...
    /**
     * Renders a popup form for viewing SupportAndHelp entities.
     *
            ...
            switch ($reqSet['key']) {
                case 'SupportAndHelp_entities':
                    $popup = [
                        ...
                        'size' => 'lg',
                        'position' => 'center',
                        'label' => 'View SupportAndHelp Entity',
                        'short_label' => '',
                        'form' => 'builder',
                        'labelType' => 'above',
                        'content' => '
                    ...
                    $message = 'SupportAndHelp entity view form loaded successfully.';
                    break;
