...
/**
 * Controller for rendering the view form for Dashboard entities.
 */
class ViewCtrl extends Controller
{
    ...
    /**
     * Renders a popup form for viewing Dashboard entities.
     *
        ...
        try {
            ...
            switch ($reqSet['key']) {
                case 'Dashboard_entities':
                    ...
                    $message = 'Dashboard entity view form loaded successfully.';
                    break;
