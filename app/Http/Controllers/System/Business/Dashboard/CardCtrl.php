...
/**
 * Controller for handling AJAX card data requests in the Dashboard module with clean UI.
 */
class CardCtrl extends Controller
{
    ...
    public function index(Request $request, array $params): JsonResponse
    {
        try {
            ...
            $view = '';
            $title = 'Success';
            $message = 'Dashboard card data retrieved successfully.';
            /****************************************************************************************************
             *                                                                                                  *
            ...
            switch ($reqSet['key']) {
                case 'Dashboard_entities':
                    ...
                    $message = 'Dashboard entity card data retrieved successfully.';
                    break;
                default:
