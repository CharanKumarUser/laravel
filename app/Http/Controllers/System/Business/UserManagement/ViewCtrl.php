...
/**
 * Controller for rendering the view form for UserManagement entities.
 */
class ViewCtrl extends Controller
{
    ...
    /**
     * Renders a popup form for viewing UserManagement entities.
     *
            ...
            switch ($reqSet['key']) {
                case 'UserManagement_entities':
                    $popup = [
                        ...
                        'size' => 'lg',
                        'position' => 'center',
                        'label' => 'View UserManagement Entity',
                        'short_label' => '',
                        'form' => 'builder',
                        'labelType' => 'above',
                        'content' => '
                    ...
                    $message = 'UserManagement entity view form loaded successfully.';
                    break;
