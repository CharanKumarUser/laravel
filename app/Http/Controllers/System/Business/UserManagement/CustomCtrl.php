...
/**
 * Custom controller for handling specific UserManagement module operations.
 */
class CustomCtrl extends Controller
{
    /**
     * Handles custom operations for the UserManagement module.
     *
    ...
    public function index(Request $request, array $params): JsonResponse
    {
        try {
            ...
            $data = [
                ...
                'message' => 'UserManagement custom operation completed successfully.'
            ];
            /****************************************************************************************************
             *                                                                                                  *
