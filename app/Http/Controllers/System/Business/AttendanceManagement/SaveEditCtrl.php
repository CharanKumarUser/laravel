...
/**
 * Controller for saving updated AttendanceManagement entities.
 */
class SaveEditCtrl extends Controller
{
    /**
     * Saves updated AttendanceManagement entity data based on validated input.
     *
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            $validated = [];
            $title = 'Success';
            $message = 'AttendanceManagement record updated successfully.';
            /****************************************************************************************************
             *                                                                                                  *
            ...
            switch ($reqSet['key']) {
                case 'AttendanceManagement_entities':
                    ...
                    $message = 'AttendanceManagement entity configuration updated successfully.';
                    break;
                default:
    ...
    /**
     * Saves bulk updated AttendanceManagement entity data based on validated input.
     *
     * @param Request $request HTTP request containing form data and token
     * @return JsonResponse JSON response with status, title, and message
     */
    public function bulk(Request $request): JsonResponse
    {
        try {
            ...
            $validated = [];
            $title = 'Success';
            $message = 'AttendanceManagement records updated successfully.';
            /****************************************************************************************************
             *                                                                                                  *
             *                             >>> MODIFY THIS SECTION (START) <<<                                  *
             *                                                                                                  *
            ...
            switch ($reqSet['key']) {
                case 'AttendanceManagement_entities':
                    ...
                    $message = 'AttendanceManagement entities configuration updated successfully.';
                    break;
                default:
                    return ResponseHelper::moduleError('Invalid Configuration', 'The configuration key is not supported.');
            }
