...
/**
 * Controller for saving new AttendanceManagement entities.
 */
class SaveAddCtrl extends Controller
{
    /**
     * Saves new AttendanceManagement entity data based on validated input.
     *
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            $validated = [];
            $title = 'Success';
            $message = 'AttendanceManagement record added successfully.';
            /****************************************************************************************************
             *                                                                                                  *
            ...
            switch ($reqSet['key']) {
                case 'AttendanceManagement_entities':
                    ...
                    $reloadTable = true;
                    $title = 'Entity Added';
                    $message = 'AttendanceManagement entity configuration added successfully.';
                    break;
                default:
