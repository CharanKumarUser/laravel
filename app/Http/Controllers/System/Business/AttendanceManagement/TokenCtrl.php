...
/**
 * Token controller for handling specific AttendanceManagement module operations.
 */
class TokenCtrl extends Controller
{
    /**
     * Handles custom operations for the AttendanceManagement module.
     *
    ...
    public function index(Request $request, array $params)
    {
        try {
            ...
            switch ($action) {
                case 'AttendanceManagement_custom':
