...
/**
 * Controller for rendering the edit form for AttendanceManagement entities.
 */
class ShowEditCtrl extends Controller
{
    /**
     * Renders a popup form for editing AttendanceManagement entities.
     *
            ...
            switch ($reqSet['key']) {
                case 'AttendanceManagement_entities':
                    $popup = [
                        ...
                        'size' => 'modal-md',
                        'position' => 'end',
                        'label' => '<i class="fa-regular fa-folder me-1"></i> Edit AttendanceManagement Entity',
                        'short_label' => '',
            ...
            switch ($reqSet['key']) {
                case 'AttendanceManagement_entities':
                    $popup = [
                        ...
                        'size' => '-',
                        'position' => 'end',
                        'label' => '<i class="fa-regular fa-folder me-1"></i> Bulk Edit AttendanceManagement Entities',
                        'short_label' => '',
