...
/**
 * Controller for handling AJAX table data requests in the AttendanceManagement module.
 */
class TableCtrl extends Controller
{
    ...
    public function index(Request $request, array $params): JsonResponse
    {
        try {
            ...
            $message = 'AttendanceManagement data retrieved successfully.';
            /****************************************************************************************************
             *                                                                                                  *
            ...
            switch ($reqSet['key']) {
                case 'AttendanceManagement_entities':
                    ...
                    $message = 'AttendanceManagement entity data retrieved successfully.';
                    break;
                default:
