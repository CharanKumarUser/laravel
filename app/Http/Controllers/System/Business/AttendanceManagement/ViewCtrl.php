...
/**
 * Controller for rendering the view form for AttendanceManagement entities.
 */
class ViewCtrl extends Controller
{
    ...
    /**
     * Renders a popup form for viewing AttendanceManagement entities.
     *
            ...
            switch ($reqSet['key']) {
                case 'AttendanceManagement_entities':
                    $popup = [
                        ...
                        'size' => 'lg',
                        'position' => 'center',
                        'label' => 'View AttendanceManagement Entity',
                        'short_label' => '',
                        'form' => 'builder',
                        'labelType' => 'above',
                        'content' => '
                    ...
                    $message = 'AttendanceManagement entity view form loaded successfully.';
                    break;
