...
/**
 * Controller for rendering the view form for Billing entities.
 */
class ViewCtrl extends Controller
{
    ...
    /**
     * Renders a popup form for viewing Billing entities.
     *
        ...
        try {
            ...
            switch ($reqSet['key']) {
                case 'Billing_entities':
                    ...
                    $message = 'Billing entity view form loaded successfully.';
                    break;
