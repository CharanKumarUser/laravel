...
/**
 * Controller for rendering the edit form for Billing entities.
 */
class ShowEditCtrl extends Controller
{
    /**
     * Renders a popup form for editing Billing entities.
     *
            ...
            switch ($reqSet['key']) {
                case 'Billing_entities':
                    $popup = [
                        ...
                        'size' => 'modal-md',
                        'position' => 'end',
                        'label' => '<i class="fa-regular fa-folder me-1"></i> Edit Billing Entity',
                        'short_label' => '',
            ...
            switch ($reqSet['key']) {
                case 'Billing_entities':
                    $popup = [
                        ...
                        'size' => '-',
                        'position' => 'end',
                        'label' => '<i class="fa-regular fa-folder me-1"></i> Bulk Edit Billing Entities',
                        'short_label' => '',
