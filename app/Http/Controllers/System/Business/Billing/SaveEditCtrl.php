...
/**
 * Controller for saving updated Billing entities.
 */
class SaveEditCtrl extends Controller
{
    /**
     * Saves updated Billing entity data based on validated input.
     *
        ...
        try {
            ...
            switch ($reqSet['key']) {
                case 'Billing_entities':
                    ...
                    $message = 'Billing entity configuration updated successfully.';
                    break;
                default:
    ...
    /**
     * Saves bulk updated Billing entity data based on validated input.
     *
     * @param Request $request HTTP request containing form data and token
     * @return JsonResponse JSON response with status, title, and message
     */
        ...
        try {
            ...
            switch ($reqSet['key']) {
                case 'Billing_entities':
                    ...
                    $message = 'Billing entities configuration updated successfully.';
                    break;
                default:
                    return ResponseHelper::moduleError('Invalid Configuration', 'The configuration key is not supported.');
            }
