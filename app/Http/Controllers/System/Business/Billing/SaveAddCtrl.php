...
/**
 * Controller for saving new Billing entities.
 */
class SaveAddCtrl extends Controller
{
    /**
     * Saves new Billing entity data based on validated input.
     *
        ...
        try {
            ...
            switch ($reqSet['key']) {
                case 'Billing_entities':
                    ...
                    $reloadTable = true;
                    $title = 'Entity Added';
                    $message = 'Billing entity configuration added successfully.';
                    break;
                default:
