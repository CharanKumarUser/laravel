...
/**
 * Controller for rendering the view form for Profile entities.
 */
class ViewCtrl extends Controller
{
    ...
    /**
     * Renders a popup form for viewing Profile entities.
     *
        ...
        try {
            ...
            switch ($reqSet['key']) {
                case 'Profile_entities':
                    ...
                    $message = 'Profile entity view form loaded successfully.';
                    break;
