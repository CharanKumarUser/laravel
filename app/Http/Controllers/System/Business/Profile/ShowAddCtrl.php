                    ...
                    if ($type == 'firstform') {
                        ...
                        $popup = [
                            ...
                            'fields' => [
                                ...
                                ['type' => 'date', 'name' => 'start_year', 'label' => 'Start Year', 'required' => true, 'col' => '6', 'attr' => ['data-date-picker' => 'date']],
                                ['type' => 'date', 'name' => 'end_year', 'label' => 'End Year', 'required' => true, 'col' => '6', 'attr' => ['data-date-picker' => 'date']],
                        ...
                        $popup = [
                            ...
                            'fields' => [
                                ...
                                ['type' => 'date', 'name' => 'start_date', 'label' => 'Start Date', 'required' => true, 'col' => '6', 'attr' => ['data-date-picker' => 'date']],
                                ['type' => 'date', 'name' => 'end_date', 'label' => 'End Date', 'required' => true, 'col' => '6', 'attr' => ['data-date-picker' => 'date']],
