...
/**
 * Controller for rendering the view form for LeavesAndRequests entities.
 */
class ViewCtrl extends Controller
{
    ...
    /**
     * Renders a popup form for viewing LeavesAndRequests entities.
     *
            ...
            switch ($reqSet['key']) {
                case 'LeavesAndRequests_entities':
                    $popup = [
                        ...
                        'size' => 'lg',
                        'position' => 'center',
                        'label' => 'View LeavesAndRequests Entity',
                        'short_label' => '',
                        'form' => 'builder',
                        'labelType' => 'above',
                        'content' => '
                    ...
                    $message = 'LeavesAndRequests entity view form loaded successfully.';
                    break;
