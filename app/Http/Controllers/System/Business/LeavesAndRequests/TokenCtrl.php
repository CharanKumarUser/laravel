...
/**
 * Token controller for handling specific LeavesAndRequests module operations.
 */
class TokenCtrl extends Controller
{
    /**
     * Handles custom operations for the LeavesAndRequests module.
     *
