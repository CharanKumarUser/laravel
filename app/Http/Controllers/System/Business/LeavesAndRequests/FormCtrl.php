...
/**
 * Controller for saving new LeavesAndRequests entities.
 */
class FormCtrl extends Controller
{
    /**
     * Saves new LeavesAndRequests entity data based on validated input.
     *
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            $validated = [];
            $title = 'Success';
            $message = 'LeavesAndRequests data saved successfully.';
            /****************************************************************************************************
             *                                                                                                  *
            ...
            switch ($reqSet['key']) {
                case 'LeavesAndRequests_entities':
                    ...
                    $title = 'Entity Added';
                    $message = 'LeavesAndRequests entity configuration added successfully.';
                    break;
                default:
