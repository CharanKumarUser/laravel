...
/**
 * Controller for handling AJAX card data requests in the SmartPresence module with clean UI.
 */
class CardCtrl extends Controller
{
    ...
    public function index(Request $request, array $params): JsonResponse
    {
        try {
            ...
            $view = '';
            $title = 'Success';
            $message = 'SmartPresence card data retrieved successfully.';
            /****************************************************************************************************
             *                                                                                                  *
            ...
            switch ($reqSet['key']) {
                case 'SmartPresence_entities':
                    ...
                    $message = 'SmartPresence entity card data retrieved successfully.';
                    break;
                default:
