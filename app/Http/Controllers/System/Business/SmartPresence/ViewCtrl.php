...
/**
 * Controller for rendering the view form for SmartPresence entities.
 */
class ViewCtrl extends Controller
{
    ...
    /**
     * Renders a popup form for viewing SmartPresence entities.
     *
            ...
            switch ($reqSet['key']) {
                case 'SmartPresence_entities':
                    $popup = [
                        ...
                        'size' => 'lg',
                        'position' => 'center',
                        'label' => 'View SmartPresence Entity',
                        'short_label' => '',
                        'form' => 'builder',
                        'labelType' => 'above',
                        'content' => '
                    ...
                    $message = 'SmartPresence entity view form loaded successfully.';
                    break;
