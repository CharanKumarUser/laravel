...
/**
 * Controller for rendering the view form for DeviceManagement entities.
 */
class ViewCtrl extends Controller
{
    ...
    /**
     * Renders a popup form for viewing DeviceManagement entities.
     *
            ...
            switch ($reqSet['key']) {
                case 'DeviceManagement_entities':
                    $popup = [
                        ...
                        'size' => 'lg',
                        'position' => 'center',
                        'label' => 'View DeviceManagement Entity',
                        'short_label' => '',
                        'form' => 'builder',
                        'labelType' => 'above',
                        'content' => '
                    ...
                    $message = 'DeviceManagement entity view form loaded successfully.';
                    break;
