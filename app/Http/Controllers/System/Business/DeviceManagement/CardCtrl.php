...
/**
 * Controller for handling AJAX card data requests in the DeviceManagement module with clean UI.
 */
class CardCtrl extends Controller
{
    ...
    public function index(Request $request, array $params): JsonResponse
    {
        try {
            ...
            $view = '';
            $title = 'Success';
            $message = 'DeviceManagement card data retrieved successfully.';
            /****************************************************************************************************
             *                                                                                                  *
            ...
            switch ($reqSet['key']) {
                case 'DeviceManagement_entities':
                    ...
                    $message = 'DeviceManagement entity card data retrieved successfully.';
                    break;
                default:
