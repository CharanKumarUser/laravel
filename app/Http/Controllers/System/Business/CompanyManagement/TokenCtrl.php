...
/**
 * Token controller for handling specific CompanyManagement module operations.
 */
class TokenCtrl extends Controller
{
    /**
     * Handles custom operations for the CompanyManagement module.
     *
