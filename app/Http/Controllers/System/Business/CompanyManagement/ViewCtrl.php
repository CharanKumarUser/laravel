...
/**
 * Controller for rendering the view form for CompanyManagement entities.
 */
class ViewCtrl extends Controller
{
    ...
    /**
     * Renders a popup form for viewing CompanyManagement entities.
     *
            ...
            switch ($reqSet['key']) {
                case 'CompanyManagement_entities':
                    $popup = [
                        ...
                        'size' => 'lg',
                        'position' => 'center',
                        'label' => 'View CompanyManagement Entity',
                        'short_label' => '',
                        'form' => 'builder',
                        'labelType' => 'above',
                        'content' => '
                    ...
                    $message = 'CompanyManagement entity view form loaded successfully.';
                    break;
