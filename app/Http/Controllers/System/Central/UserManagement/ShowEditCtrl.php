            ...
            switch ($reqSet['key']) {
                ...
                case 'business_designation_data':
                    $popup = [
                        ...
                        'labelType' => 'floating',
                        'fields' => [
                            ['type' => 'text', 'name' => 'name', 'label' => 'Designation', 'required' => true, 'col' => '12', 'value' => $data->name ?? ''],
                            ['type' => 'textarea', 'name' => 'description', 'label' => 'Description', 'required' => false, 'col' => '12','value' => $data->description ?? ''],
                            ['type' => 'select', 'name' => 'is_active', 'label' => 'Is Active', 'options' => ['1' => 'Yes', '0' => 'No'], 'required' => true, 'col' => '12', 'attr' => ['data-select' => 'dropdown'],'value' => $data->is_active ?? '1'],
                        ],
                        'type' => 'modal',
                        'size' => 'modal-md',
                        'position' => 'end',
                        'label' => '<i class="fa-regular fa-user me-1"></i>Add Designation',
                        'short_label' => 'Define and add your own Designation for your company.',
                        'button' => 'Add',
                        'script' => 'window.general.select();window.general.unique();window.general.pills();'
                    ];
                    break;
                ...
                case 'open_um_users':
                    ...
                    $commonFields = [
                        ...
                        ['type' => 'text', 'name' => 'username', 'label' => 'User Name', 'required' => false, 'col' => '3', 'value' => $userData['username'] ?? '', 'attr' => ['data-validate' => 'username', 'maxlength' => '100', 'data-unique' => Skeleton::skeletonToken('open_um_users_username') . '_u', 'data-unique-msg' => 'This Username is already exists.']],
                        ...
                        ['type' => 'text', 'name' => 'first_name', 'label' => 'First Name', 'required' => true, 'col' => '4', 'value' => $userData['first_name'] ?? ''],
                        ['type' => 'text', 'name' => 'last_name', 'label' => 'Last Name', 'required' => true, 'col' => '4', 'value' => $userData['last_name'] ?? ''],
                        ['type' => 'select', 'name' => 'gender', 'label' => 'Gender', 'options' => ['male' => 'Male', 'female' => 'Female', 'non_binary' => 'Non-binary', 'other' => 'Other', 'prefer_not_to_say' => 'Prefer not to say'], 'required' => true, 'col' => '4', 'attr' => ['data-select' => 'dropdown', 'data-value' => $userData['gender'] ?? '']],
                        ['type' => 'date', 'name' => 'date_of_birth', 'label' => 'Date of Birth', 'required' => false, 'col' => '4', 'value' => $userData['date_of_birth'] ?? '', 'attr' => ['data-date-picker' => 'date', 'data-date-picker-allow' => 'past']],
                        ['type' => 'email', 'name' => 'email', 'label' => 'Email', 'required' => true, 'col' => '4', 'value' => $userData['email'] ?? ''],
                        ['type' => 'text', 'name' => 'phone', 'label' => 'Phone', 'required' => false, 'col' => '4', 'value' => $userData['phone'] ?? ''],
                        ...
                        ['type' => 'text', 'name' => 'job_title', 'label' => 'Job Title/Role (Optional)', 'required' => false, 'col' => '4', 'value' => $userData['job_title'] ?? ''],
                        ['type' => 'text', 'name' => 'department', 'label' => 'Department (Optional)', 'required' => false, 'col' => '4', 'value' => $userData['department'] ?? ''],
                    ];
                    $popup = [
                        'form' => 'builder',
                        'labelType' => 'floating',
                ...
                case 'open_um':
                    ...
                    $userResult = Data::fetch($system, 'users', $userParams, '1');
                    ...
                    $userInfoResult = Data::fetch($system, 'user_info', $userInfoParams, '1');
                    ...
                    if ($type == 'main') {
                        $popup = [
                            ...
                            'fields' => [
                                ...
                                ['type' => 'raw', 'html' => '<div class="file-upload-container mt-3" data-file="image" data-file-crop="profile" data-label="Profile Photo" data-name="profile_photo" data-crop-size="300:300" data-target="#profile-photo-input" data-recommended-size="300px x 300px" data-file-size="2" data-src="' . FileManager::getFile($userData->profile) . '"></div>', 'col' => '12'],
                        ...
                        $popup = [
                            ...
                            'fields' => [
                                ['type' => 'hidden', 'col_class'=>'my-0', 'name' => 'type', 'value' => $type, 'class'=>['mb-0']],
                                ['type' => 'hidden', 'col_class'=>'my-0', 'name' => 'user_id', 'value' => $userId, 'class'=>['mb-0']],
                                ['type' => 'raw', 'html' => '<div class="file-upload-container mt-3" data-file="image" data-file-crop="cover" data-label="Cover Photo" data-name="cover_photo" data-crop-size="400:150" data-target="#profile-photo-input" data-recommended-size="600px x 200px" data-file-size="2" data-src="' . FileManager::getFile($userData->cover) . '"></div>', 'col' => '12'],
                            ],
                            'type' => 'modal',
                            'size' => 'modal-lg',
                            'position' => 'end',
                        ...
                        $popup = [
                            ...
                            'fields' => [
                                [
                                    ...
                                    'html' => '
                                        <div class="w-100 rounded p-2 text-center">
                                            ...
                                            <h5 class="text-danger mb-2">Confirm Role Deletion</h5>
                                            <p class="mb-0 text-muted">
                                                Are you sure you want to delete this user role?<br>
                                                <strong>This action is permanent and cannot be undone.</strong><br>
                                                Deleting a role may affect permissions and access for the associated user.
                                            </p>
                                        </div>',
                                    'col' => '12'
                                ],
                                ['type' => 'hidden', 'col_class'=>'my-0', 'name' => 'type', 'value' => $type, 'class'=>['mb-0']],
                                ['type' => 'hidden', 'col_class'=>'my-0', 'name' => 'user_id', 'value' => $userId, 'class'=>['mb-0']],
                                ['type' => 'hidden', 'name' => 'role_id', 'value' => $dataId ?? ''],
                            ],
                            'type' => 'modal',
                            'size' => 'modal-md',
                            'position' => 'end',
                            'short_label' => 'Delete User Role',
                            'label' => '<i class="fa-solid fa-trash"></i> Confirm Role Deletion',
                            'button' => 'Delete',
                            'script' => '',
                        ];
