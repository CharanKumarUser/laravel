        ...
        try {
            ...
            switch ($reqSet['key']) {
                case 'open_um_roles':
                    ...
                    Developer::info('Saving Designation Data', ['request_data' => $request->all()]);
                    $validator = Validator::make($request->all(), [
                        'name'               => ['required', 'string', 'max:255'],
                        'is_active'          => ['required', 'string', 'max:255'],
                        'description'        => ['nullable', 'string', 'max:255'],
                ...
                case 'open_um_admins':
                    try {
                        ...
                        $usersResult = Data::update($system, 'users', $usersData, [['colomn'=>'user_id', 'value'=> $reqSet['id']]], $token);
                        if ($system != "central") {
                            $usersResult = Data::update('central', 'users', $usersData, ['user_id' => $reqSet['id']], $token);
                        }
                        ...
                        $roleResult = Data::update($system, 'user_roles', $roleData, [['colomn'=>'user_id', 'value'=> $reqSet['id']]], $token);
                        ...
                        $userInfoResult = Data::update($system, 'user_info', $userInfoData, [['colomn'=>'user_id', 'value'=> $reqSet['id']]], $token);
                        ...
                        if (!empty($validated['scope_id'])) {
                            ...
                            $scopeUsersResult = Data::update($system, 'scope_mapping', $scopeUsers, [['colomn'=>'user_id', 'value'=> $reqSet['id']]], $token);
                            ...
                            if (!empty($validated['scope_data'])) {
                                ...
                                $scopeDataResult = Data::update($system, 'scope_data', $scopeData, [['colomn'=>'user_id', 'value'=> $reqSet['id']]], $token);
                ...
                case 'open_um':
                    ...
                    $userParams = [
                        'columns' => ['user_id', 'business_id', 'username', 'email', 'password', 'first_name', 'last_name', 'settings', 'email_verified_at', 'two_factor_confirmed_at', 'last_password_changed_at', 'last_login_at', 'account_status'],
                    ...
                    $userInfoParams = [
                        'columns' => ['phone', 'alt_phone', 'job_title', 'organization', 'department', 'location', 'industry', 'linkedin_url', 'github_url', 'portfolio_url', 'bio'],
                    ...
                    if ($type == 'bio') {
                        ...
                        $userInfoWhere =[['colomn'=>'user_id', 'value'=> $reqSet['id']]];
                        $userInfoResult = Data::update($system, 'user_info', $userinfo, $userInfoWhere, $token);
                        if (!$userInfoResult['status']) {
                            return ResponseHelper::moduleError('User Info Update Failed', $userInfoResult['message'], 400);
                        }
                        ...
                        $usersWhere = [['colomn'=>'user_id', 'value'=> $reqSet['id']]];
                        ...
                        $userInfoResult = Data::update($system, 'user_info', $userinfo, $userInfoWhere, $token);
                        if ($system != "central") {
                            $userInfoResult = Data::update('central', 'user_info', $userinfo, $userInfoWhere, $token);
                        }
                        if (!$userInfoResult['status']) {
                            return ResponseHelper::moduleError('User Info Update Failed', $userInfoResult['message'], 400);
                        }
