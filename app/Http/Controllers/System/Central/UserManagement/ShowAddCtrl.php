...
use App\Facades\{Data, Developer, Scope, Select, Skeleton, FileManager};
            ...
            switch ($reqSet['key']) {
                case 'open_um_roles':
                    $popup = [
                        ...
                        'fields' => [
                            ...
                            ['type' => 'text', 'name' => 'name', 'label' => 'Name', 'required' => true, 'col' => '6', 'attr' => ['maxlength' => '20', 'data-unique' => Skeleton::skeletonToken('open_roles') . '_u', 'data-unique-msg' => 'This key is already registered']],
                ...
                case 'business_designation_data':
                    $popup = [
                        ...
                        'labelType' => 'floating',
                        'fields' => [
                            ['type' => 'text', 'name' => 'name', 'label' => 'Designation', 'required' => true, 'col' => '12'],
                            ['type' => 'textarea', 'name' => 'description', 'label' => 'Description', 'required' => false, 'col' => '12'],
                            ['type' => 'select', 'name' => 'is_active', 'label' => 'Is Active', 'options' => ['1' => 'Yes', '0' => 'No'], 'required' => true, 'col' => '12', 'attr' => ['data-select' => 'dropdown']],
                        ],
                        'type' => 'modal',
                        'size' => 'modal-md',
                        'position' => 'end',
                ...
                case 'open_um_admins':
                    ...
                    $commonFields = [
                        ...
                        ['type' => 'text', 'name' => 'username', 'label' => 'User Name', 'required' => false, 'col' => '3', 'attr' => ['data-validate' => 'username', 'maxlength' => '100', 'data-unique' => Skeleton::skeletonToken('open_um_users_username') . '_u', 'data-unique-msg' => 'This Username is already exists.']],
                        ...
                        ['type' => 'text', 'name' => 'first_name', 'label' => 'First Name', 'required' => true, 'col' => '4'],
                        ['type' => 'text', 'name' => 'last_name', 'label' => 'Last Name', 'required' => true, 'col' => '4'],
                        ['type' => 'select', 'name' => 'gender', 'label' => 'Gender', 'options' => ['male' => 'Male', 'female' => 'Female', 'non_binary' => 'Non-binary', 'other' => 'Other', 'prefer_not_to_say' => 'Prefer not to say'], 'required' => true, 'col' => '4', 'attr' => ['data-select' => 'dropdown']],
                        ['type' => 'date', 'name' => 'date_of_birth', 'label' => 'Date of Birth', 'required' => false, 'col' => '6', 'attr' => ['data-date-picker' => 'date', 'data-date-picker-allow' => 'past']],
                        ['type' => 'email', 'name' => 'email', 'label' => 'Email', 'required' => true, 'col' => '4'],
                        ['type' => 'text', 'name' => 'phone', 'label' => 'Phone', 'required' => false, 'col' => '4'],
                        ['type' => 'date', 'name' => 'hire_date', 'label' => 'Joining Date', 'required' => false, 'col' => '4', 'attr' => ['data-date-picker' => 'date', 'data-date-picker-allow' => 'past']],
                        ['type' => 'text', 'name' => 'job_title', 'label' => 'Job Title/Role (Optional)', 'required' => false, 'col' => '4'],
                        ['type' => 'select', 'name' => 'designation_id', 'label' => 'Designation', 'options' => Select::options('designations', 'array', ['designation_id' => 'name']), 'required' => true, 'col' => '4', 'attr' => ['data-select' => 'dropdown']],
                    ];
                    $popup = [
                        'form' => 'builder',
                        'labelType' => 'floating',
