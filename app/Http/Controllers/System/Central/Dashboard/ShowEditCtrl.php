...
/**
 * Controller for rendering the edit form for Dashboard entities.
 */
class ShowEditCtrl extends Controller
{
    /**
     * Renders a popup form for editing Dashboard entities.
     *
            ...
            switch ($reqSet['key']) {
                case 'Dashboard_entities':
                    $popup = [
                        ...
                        'size' => 'modal-md',
                        'position' => 'end',
                        'label' => '<i class="fa-regular fa-folder me-1"></i> Edit Dashboard Entity',
            ...
            switch ($reqSet['key']) {
                case 'Dashboard_entities':
                    $popup = [
                        ...
                        'size' => '-',
                        'position' => 'end',
                        'label' => '<i class="fa-regular fa-folder me-1"></i> Bulk Edit Dashboard Entities',
