...
/**
 * Controller for handling AJAX card data requests in the Profile module with clean UI.
 */
class CardCtrl extends Controller
{
    ...
    public function index(Request $request, array $params): JsonResponse
    {
        try {
            ...
            $view = '';
            $title = 'Success';
            $message = 'Profile card data retrieved successfully.';
            /****************************************************************************************************
             *                                                                                                  *
            ...
            switch ($reqSet['key']) {
                case 'Profile_entities':
                    ...
                    $message = 'Profile entity card data retrieved successfully.';
                    break;
                default:
