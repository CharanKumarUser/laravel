            ...
            switch ($reqSet['key']) {
                case 'business_support_tickets':
                    $columns = [
                        ...
                        'business_name'    => ['business_systems.name AS business_name', true],
                        'company_id'       => ['supports.company_id', true],
                        'user_id'          => ['supports.user_id', true],
                        'profile'          => ['users.profile AS profile', true],
                        'first_name'       => ['users.first_name AS first_name', true],
                        'last_name'        => ['users.last_name AS last_name', true],
                    ...
                    $joins = [
                        ['type' => 'left', 'table' => 'users', 'on' => [['supports.user_id', 'users.user_id']]],
                        ['type' => 'left', 'table' => 'business_systems', 'on' => [['supports.business_id', 'business_systems.business_id']]]
                        ...
                        <div class="card">
                            <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                             <div class="d-flex align-items-center">
                                    <span class="avatar avatar-lg avatar-rounded border rounded-circle">
                                    ...
                                    <div class="ms-2">
                                        <div class="fs-12 fw-semibold">::first_name:: ::last_name::</div>
                                        <div>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <div class="d-flex justify-content-between mb-1">
                                        ...
                                        <div><span class="fw-bold">Issue At: </span><span class="badge bg-light rounded-pill border border-1 stext-black">::issue_scope::</span></div>
                                    </div>
