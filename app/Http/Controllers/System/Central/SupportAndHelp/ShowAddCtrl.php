                ...
                case 'business_support_tickets':
                    $popup = [
                        ...
                        'fields' => [
                            ...
                            ['type' => 'select', 'name' => 'issue_scope', 'label' => 'Issue Scope', 'options' => ['Support' => 'Support', 'Developer' => 'Developer'], 'required' => true, 'col' => '6', 'attr' => ['data-select' => 'dropdown']],
                            ['type' => 'select', 'name' => 'issue_priority', 'label' => 'Priority', 'options' => ['Low' => 'Low', 'Medium' => 'Medium', 'High' => 'High', 'Critical' => 'Critical'], 'required' => true, 'col' => '12', 'attr' => ['data-select' => 'dropdown']],
                            ['type' => 'text', 'name' => 'subject', 'label' => 'Subject', 'required' => true, 'col' => '12', 'attr' => ['maxlength' => '255']],
