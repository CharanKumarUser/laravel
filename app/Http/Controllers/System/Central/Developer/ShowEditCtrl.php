...
class ShowEditCtrl extends Controller
{
    ...
    public function index(Request $request, array $params): JsonResponse
    {
        try {
            ...
            Developer::alert('this is Boss',['bossing'=>$reqSet]);
            ...
            switch ($reqSet['key']) {
                ...
                case 'central_skeleton_tokens':
                    ...
                    $popup = [
                        ...
                        'fields' => [
                            ...
                            ['type' => 'select', 'name' => 'type', 'label' => 'Type', 'options' => ['data' => 'Data', 'unique' => 'Unique', 'select' => 'Select', 'other' => 'Other'], 'required' => true, 'col' => '4', 'attr' => ['data-select' => 'dropdown', 'data-value' => $data->type]],
                            ...
                            ['type' => 'select', 'name' => 'validate', 'label' => 'Validate', 'options' => ['0' => 'No', '1' => 'Yes'], 'required' => true, 'col' => '4', 'attr' => ['data-select' => 'dropdown', 'data-value' => $data->validate]],
                ...
                case 'central_skeleton_dropdowns':
                    $popup = [
                        ...
                        'labelType' => 'floating',
                        'fields' => [
                            ['type' => 'text', 'name' => 'name', 'label' => 'Name', 'required' => true, 'value' => $data->name, 'col' => '12', 'attr' => ['data-validate' => 'key', 'maxlength' => '100', 'data-unique' => Skeleton::skeletonToken('central_skeleton_dropdowns_unique') . '_u', 'data-unique-msg' => 'This name is already registered']],
                            ['type' => 'repeater', 'name' => 'pairs', 'set' => 'pair', 'value' => $data->pairs, 'fields' => [['type' => 'text', 'name' => 'label', 'label' => 'Value', 'placeholder' => 'Value', 'required' => true], ['type' => 'text', 'name' => 'value', 'label' => 'Display', 'placeholder' => 'Display', 'required' => true]], 'col' => '12'],
                        ],
                        'type' => 'modal',
                        'size' => 'modal-md',
                        'position' => 'end',
                ...
                case 'central_skeleton_modules':
                    ...
                    $popup = [
                        ...
                        'fields' => [
                            ...
                            ['type' => 'text', 'name' => 'icon', 'label' => 'Icon', 'required' => true, 'col' => '4', 'value' => $data->icon],
                            ['type' => 'number', 'name' => 'order', 'label' => 'Order', 'required' => true, 'col' => '4', 'value' => $data->order],
                            ...
                            ['type' => 'select', 'name' => 'in_view', 'label' => 'In View', 'options' => ['admin' => 'Admin', 'user' => 'User', 'open' => 'Open'], 'required' => true, 'col' => '4', 'attr' => ['data-select' => 'dropdown', 'data-value' => $data->in_view]],
                            ...
                            ['type' => 'label', 'name' => 'label', 'label' => 'Create Structures', 'col_class' => 'd-flex justify-content-start align-items-center', 'col' => '12'],
                ...
                case 'central_skeleton_sections':
                    ...
                    $popup = [
                        ...
                        'fields' => [
                            ...
                            ['type' => 'label', 'name' => 'label', 'label' => 'Create Structures', 'col_class' => 'd-flex justify-content-start align-items-center', 'col' => '4'],
                            ['type' => 'switch', 'name' => 'blades', 'label' => 'Blades', 'required' => false, 'col' => '4'],
                            ['type' => 'switch', 'name' => 'permissions', 'label' => 'Permissions', 'required' => false, 'col' => '4'],
                ...
                case 'central_skeleton_user_permissions':
                    ...
                    if ($data->business_id != 'CENTRAL') {
                        ...
                        $permissions = Skeleton::loadPermissions('all', 'user', 'user_id', $reqSet['id']);
                    }
                    Developer::alert('this is user',['the user'=>$reqSet['id']]);
                    Developer::alert('this is perm',['the perm'=>$permissions]);
                    $popup = [
                        'form' => 'custom',
                        'labelType' => 'floating',
                        'content' => '
                                ...
                                <div class="row justify-content-start mt-1 g-3">
                                    <div class="col-md-3">
                                        <div class="float-input-control">
                                            <select class="form-float-input" placeholder="business_id" name="business_id" data-select="dropdown" data-value='.$data->business_id.'>
                                                ' . Select::options('businesses', 'html', ['business_id' => 'name']) . '
                                            </select>
                                            <label class="form-float-label">
                                                Business <span class="text-danger">*</span>
                ...
                case 'central_skeleton_templates':
                    ...
                    if ($data->type == 'email') {
                        ...
                        $script = 'window.general.pills();window.skeleton.template("email", "for-email-template", "' . addslashes($data->placeholders) . '", "' . addslashes($encodedContent) . '");';
                    } else {
                        $mdlSize = 'modal-lg';
                ...
                case 'central_skeleton_restrictions':
                    $popup = [
                        ...
                        'labelType' => 'floating',
                        'fields' => [
                            ['type' => 'text', 'name' => 'type', 'label' => 'Type', 'required' => true, 'value'=>$data->type, 'col' => '12', 'attr' => ['maxlength' => '100']],
