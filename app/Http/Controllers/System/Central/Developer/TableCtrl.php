    ...
    public function index(Request $request, array $params): JsonResponse
    {
        try {
           ...
           switch ($reqSet['key']) {
                ...
                // Define columns for token data
                $columns = [
                    'id' => ['skeleton_restrictions.id', true],
                    'type' => ['skeleton_restrictions.type', true],
                    'value' => ['skeleton_restrictions.value', true],
                    'updated_at' => ['skeleton_restrictions.updated_at', true],
                ];
                $title = 'Restrictions Retrieved';
                $message = 'Restrictions configuration data retrieved successfully.';
                break;
