            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <button class="btn btn-primary skeleton-popup" data-token="@skeletonToken('business_support_tickets')_a"
                            data-type="add">Raise
                            Tickets
                        </button>
                    </div>
                    <div class="row">
                        <div class="col-xl-8">
                            <div data-skeleton-card-set="@skeletonToken('business_support_tickets')_c_{{\App\Facades\Skeleton::authUser()->user_id}}" data-placeholder="card|9" data-type="scroll"
