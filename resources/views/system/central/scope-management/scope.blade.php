{{-- Template: Scopes Page - Auto-generated --}}
...
@push('scripts') 
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.skeleton.tree('scope-tree-container', scopeData, '{!! $data['token'] !!}');
        ...
        <div class="my-auto mb-2">
            ...
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="#">Scopes</a></li>
                </ol>
            </nav>
        </div>
        <div></div>
       ...
       <div class="card">
                <div class="card-body">
                    ...
                    <div class="tab-content mt-2 pt-2 border-top">
                        ...
                        <div class="tab-pane fade" id="scopes_card_view" role="tabpanel" aria-labelledby="scopes-tab">
                        ...
                        <div class="tab-pane fade" id="scopes_table_view" role="tabpanel" aria-labelledby="scopes-tab">
