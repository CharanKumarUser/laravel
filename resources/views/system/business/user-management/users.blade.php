                ...
                <div class="card-body">
                            ...
                            @foreach ($tabs as $id => $label)
                                <li class="nav-item">
                                    <a class="nav-link {{ $loop->first ? 'active' : '' }}" id="{{ $id }}-tab"
                                        data-skl-action="b" data-bs-toggle="tab" href="#{{ $id }}" role="tab"
                                        aria-controls="{{ $id }}"
                                        aria-selected="{{ $loop->first ? 'true' : 'false' }}" data-type="add"
                                        data-token="@skeletonToken('open_um_users')_a" data-text="Add User" data-target="#outer-add-btn">
                                        {{ $label }}
                                    </a>
                                </li>
                            @endforeach
                    ...
                    <div class="tab-content mt-3" id="outer-tabs-content">
                        ...
                        <div class="tab-pane fade show active" id="admins" role="tabpanel" aria-labelledby="admins-tab">
                            ...
                            <ul class="nav nav-tabs nav-tabs-solid bg-transparent border-bottom-0 data-skl-action" id="admins-inner-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="admins-card-tab" data-skl-action="b" data-bs-toggle="tab" href="#admins-card"
                                        role="tab">
                                        <i class="ti ti-layout-grid"></i>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="admins-table-tab" data-skl-action="b" data-bs-toggle="tab" href="#admins-table"
                                        role="tab">
                            ...
                            <div class="tab-content mt-2">
                                <div class="tab-pane fade show active" id="admins-card" role="tabpanel">
                                    <div data-skeleton-card-set="@skeletonToken('open_um_users')_c_ADMIN" data-placeholder="card|9"
                                        data-type="scroll" data-limit="10"
                        ...
                        <div class="tab-pane fade" id="users" role="tabpanel" aria-labelledby="users-tab">
                            ...
                            <ul class="nav nav-tabs nav-tabs-solid bg-transparent border-bottom-0 data-skl-action" id="users-inner-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="users-card-tab" data-skl-action="b" data-bs-toggle="tab" href="#users-card"
                                        role="tab">
                                        <i class="ti ti-layout-grid"></i>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="users-table-tab" data-skl-action="b" data-bs-toggle="tab" href="#users-table"
                                        role="tab">
                                        <i class="ti ti-list"></i>
                                    </a>
                                </li>
                            ...
                            <div class="tab-content mt-2">
                                <div class="tab-pane fade show active" id="users-card" role="tabpanel">
                                    <div data-skeleton-card-set="@skeletonToken('open_um_users')_c" data-placeholder="card|9"
                                        data-type="scroll" data-limit="10"
                                        data-container="row">
                                    </div>
                                </div>
