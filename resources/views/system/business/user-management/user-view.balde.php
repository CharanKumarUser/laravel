{{-- Template: User View Page - Auto-generated --}}
            ...
            <div class="my-auto mb-2">
                ...
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item "><a href="{{ url('/user-management/user') }}">User Managements</a></li>
                            ...
                            <div class="card-body text-center" style="padding-top: 74px;">
                                <div class="text-center pb-3 border-bottom mb-2">
                                    <div class="mb-3">
                                        ...
                                        <span
                                            class="badge badge-soft-secondary fw-medium"></span>
                                    </div>
