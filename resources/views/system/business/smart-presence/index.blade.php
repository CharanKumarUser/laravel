{{-- Template: Smart Presence Page - Auto-generated --}}
@extends('layouts.system-app')
@section('title', 'Smart Presence')
...
<div class="content">
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb">
        <div class="my-auto mb-2">
            <h3 class="mb-1">Smart Presence</h3>
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ url('/dashboard') }}"><i class="ti ti-smart-home"></i></a></li>
                    <li class="breadcrumb-item active" aria-current="page"><a href="#">Smart Presence</a></li>
                </ol>
            </nav>
        </div>
        <div></div>
