{{-- Template: Devices Page - Auto-generated --}}
            ...
            <div class="my-auto mb-2">
                ...
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="#">Devices</a></li>
                    </ol>
                </nav>
            </div>
            <div></div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <button class="btn btn-primary skeleton-popup" data-token="@skeletonToken('business_devices')_a" data-type="add">Add
                            Device
                        </button>
                    </div>
                    <div data-skeleton-table-set="@skeletonToken('business_devices')_t" data-bulk="update"></div>
                </div>
            </div>
            {{-- ************************************************************************************************
        *                                                                                                  *
