{{-- Template: Knowledge Base Page - Auto-generated --}}
        ...
        <div class="my-auto mb-2">
            ...
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item "><a href="{{ url('/support-and-help') }}">Support And Help</a></li>
                    <li class="breadcrumb-item active" aria-current="page"><a href="#">Knowledge Base</a></li>
                </ol>
            </nav>
        </div>
        <div></div>
