{{-- Template: Monthly Attendance Page - Auto-generated --}}
...
<div class="content">
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb">
        <div class="my-auto mb-2">
            <h3 class="mb-1">Monthly Attendance</h3>
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="#">Monthly Attendance</a></li>
                </ol>
            </nav>
        </div>
        <div></div>
