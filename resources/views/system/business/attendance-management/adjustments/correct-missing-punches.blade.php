{{-- Template: Correct Missing Punches Page - Auto-generated --}}
@extends('layouts.system-app')
@section('title', 'Correct Missing Punches')
...
<div class="content">
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb">
        <div class="my-auto mb-2">
            <h3 class="mb-1">Correct Missing Punches</h3>
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item "><a href="{{ url('/attendance-management/adjustments') }}">Adjustments</a></li>
                    <li class="breadcrumb-item active" aria-current="page"><a href="#">Correct Missing Punches</a></li>
                </ol>
            </nav>
        </div>
        <div></div>
