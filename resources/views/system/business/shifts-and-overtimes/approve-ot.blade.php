...
@section('title', 'Approve Overtime')
@push('styles')
@endpush
@push('pre-scripts')
@endpush
    ...
    <div class="content">
        <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb">
            <div class="my-auto mb-2">
                <h3 class="mb-1">Approve Overtime</h3>
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="#">Approve Overtime</a></li>
                    </ol>
                </nav>
            </div>
            <div></div>
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h4 class="card-title mb-0">Pending/Recent Overtime Requests</h4>
                </div>
                <div class="card-body">
                    <div data-skeleton-table-set="@skeletonToken('business_ot_approve')_t"></div>
                </div>
            </div>
        </div>
    </div>
