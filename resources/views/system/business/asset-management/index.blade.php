{{-- Template: Asset Management Page - Auto-generated --}}
...
<div class="content">
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb">
        <div class="my-auto mb-2">
            <h3 class="mb-1">Asset Management</h3>
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ url('/dashboard') }}"><i class="ti ti-smart-home"></i></a></li>
                    <li class="breadcrumb-item active" aria-current="page"><a href="#">Asset Management</a></li>
                </ol>
            </nav>
        </div>
        <div></div>
