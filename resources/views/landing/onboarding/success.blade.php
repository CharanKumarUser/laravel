...
@section('title', 'Got It :: Onboarding - Success')
@section('content')
...
<main class="empty-main">
    ...
    <section class="onboarding-hero" data-aos="fade-up" data-aos-delay="100">
        <div class="container">
            <h1 class="display-4 fw-bold mb-3">Onboarding Complete!</h1>
            <p class="lead">Your account is now active with Avind ADMS-compatible biometric devices configured. Welcome to Got It!</p>
        </div>
        ...
        <div class="container">
            <div class="onboarding-card text-center" data-aos="fade-up" data-aos-delay="200">
                <div class="card-body p-4">
                    ...
                    <p class="engage-text mb-4">Your payment was processed successfully, and your Got It account is now active with your biometric devices configured for HR management. Start managing your tasks today!</p>
                    ...
                    <a href="{{ route('dashboard') }}" class="btn action-btn mt-4">Go to Dashboard</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-12 text-center">
                    ...
                    <p class="text-white mb-3">Our support team is here to help you get started with your Avind ADMS-compatible biometric devices and Got It platform!</p>
                    ...
                    <form method="POST" action="{{ $formAction }}" class="mt-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <textarea name="message" class="form-control" rows="4" placeholder="Your Question About Biometric Device Setup or Got It Platform" required pattern=".{10,500}" title="Message should be 10 to 500 characters.">{{ old('message') }}</textarea>
                                @error('message')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @endif
                            </div>
