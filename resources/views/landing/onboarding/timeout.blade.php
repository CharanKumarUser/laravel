...
@section('title', 'Got It :: Onboarding - Timeout')
@section('content')
...
<main class="empty-main">
    ...
    <section class="onboarding-hero" data-aos="fade-up" data-aos-delay="100">
        <div class="container">
            <h1 class="display-4 fw-bold mb-3">Onboarding Timeout</h1>
            <p class="lead">Your onboarding session for Avind ADMS-compatible biometric device setup has expired or is suspended. Please review your details, restart, or contact support.</p>
        </div>
        ...
        <div class="container">
            <div class="onboarding-card text-center" data-aos="fade-up" data-aos-delay="200">
                <div class="card-body p-4">
                    <i class="bi bi-clock-fill fa-5x text-warning mb-4"></i>
                    <h2 class="section-title">Session Expired or Suspended</h2>
                    <p class="engage-text mb-4">Your onboarding session for the Got It platform and Avind ADMS-compatible biometric device setup has timed out or is currently suspended. Please review your configured devices below, restart the onboarding process, or contact our support team for assistance.</p>
                    ...
                    <a href="{{ url('/g/onboarding') }}" class="btn action-btn mt-4">Restart Onboarding</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-12 text-center">
                    ...
                    <p class="text-white mb-3">Our support team is here to help you resume your onboarding or assist with your Avind ADMS-compatible biometric device setup!</p>
                    ...
                    <form method="POST" action="{{ $formAction }}" class="mt-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <textarea name="message" class="form-control" rows="4" placeholder="Your Question About Onboarding Timeout or Biometric Device Setup" required pattern=".{10,500}" title="Message should be 10 to 500 characters.">{{ old('message') }}</textarea>
                                @error('message')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @endif
                            </div>
